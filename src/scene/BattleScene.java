	...
	public static void enemyDied() {
		...
		case 3:
			if (AllCharacter.getCharacters().get(3).getHealth() <= 0) {
				...
				alert.showAndWait();
				AllCharacter.getCharacters().get(0).setHealth(AllCharacter.getCharacters().get(0).getMAXHEALTH());
				AllCharacter.getCharacters().get(0).setMana(AllCharacter.getCharacters().get(0).getMAXMANA());
				AllCharacter.getCharacters().get(1).setHealth(AllCharacter.getCharacters().get(0).getMAXHEALTH());
				AllCharacter.getCharacters().get(1).setMana(AllCharacter.getCharacters().get(0).getMAXMANA());
				AllCharacter.getCharacters().get(2).setHealth(AllCharacter.getCharacters().get(0).getMAXHEALTH());
